...
val_dataset_tfrecord = glob.glob("./tfrecords-dataset/sigtia-configuration2-splits/fold_4/valid/*.tfrecords")
test_dataset_tfrecord = glob.glob("./tfrecords-dataset/sigtia-configuration2-splits/fold_4/test/*.tfrecords")
    ...
    if eval_flag:
        eval_result = classifier.evaluate(
            input_fn=lambda: dataset.tfrecord_val_input_fn(test_dataset_tfrecord,
                                                           batch_size=hparams['batch_size'],
                                                           num_epochs=1),
            steps=hparams['test_steps'], checkpoint_path="./model/model.ckpt-1477730")

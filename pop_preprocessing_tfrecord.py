...
vars = np.load("mean_per_bin.npz")

prep.spec_var_per_bin(val_audio_addrs, mean_1=vars['bin_mean_1'], mean_2=vars['bin_mean_2'], mean_3=vars['bin_mean_3'], filename='var_per_bin', num_bands=num_bands)
